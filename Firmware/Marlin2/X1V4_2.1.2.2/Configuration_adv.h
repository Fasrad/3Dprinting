 ...
 */
#define XY_FREQUENCY_LIMIT      20 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.// set to 20
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  //enabeld --chaz
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
//#define MINIMUM_STEPPER_PULSE 2 //enabled; might want to use DRVs?
